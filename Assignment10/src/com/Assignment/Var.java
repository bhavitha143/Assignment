...
public class Var {
	...
	*//*class Var {
	...
	//var cannot be used as a Generic type/*import java.util.*;
	/*class Var {
	//public static void main(String[] args)
	{
	...
	/*
	// Java program to demonstrate that
	//var cannot be used with Generic type/*import java.util.*;
	class Var {
	public static void main(String[] args)
	{
	...
	*///Java program to demonstrate that var cannot be used with LambdaExpression/*import java.util.*;
	/*interface myInt {
	int add(int a, int b);
	}
	class Var {
